""" Contains a design abstraction and the ability to generate
configuration dictionaries for a new design implementing k interfaces.
...
def gen_config_dict(interface_names):
    """ Generates a configuration dictionary for the given interfaces.
    :param interface_names:  List of valid interface names
    :type interface_names: list

    :return a dictionary of {interface_name : config_dict} where
    config_dict is specified in _gen_config_dict
    :rtype: dict
    """
...
def _gen_config_dict(interface_name):
    """ Generates a configuration dictionary for the given interface.
    :param interface_names:  A valid interface name
    :type interface_names: str

    :return a dictionary of {part : '', dsn_variables: {k : v}, signals : []}
    config_dict is specified in _gen_config_dict
    :rtype: dict
    """
...
def parse_interface(interface, from_yaml):
    """Parses all information about a given interface in this design and
    updates the given Interface.
...
class Design:
    """The Design class contains information about a full design, which may
    ...
    def parse_yaml(self, yaml_file):
        """Parses a given yaml file and adds to list of interfaces for this
        design.
        ...
        self.interfaces.append(parse_interface(interface, yaml_dict))
    ...
    def parse_yamls(self, design_name):
        ...
        if yaml_files == []:
            LOGGER.warning('No yamls found in %s', yaml_dir)
